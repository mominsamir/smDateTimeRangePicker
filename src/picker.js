...
(function(){
	...
	var TimePickerCtrl = function($scope, picker){
		...
		self.hourLabel = picker.hourLabel;
		self.minuteLabel = picker.minuteLabel;
		self.hourItems =[];
		self.minuteCells =[];
...
function picker(){
    ...
    return {
        ...
        setHourLabel: function (param) {
            hourLabel = param;
        },
        setMinuteLabel: function (param) {
            minuteLabel = param;
        },
