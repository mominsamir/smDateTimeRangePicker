...
RangePickerCtrl.prototype.setNgModelValue = function(startDate,divider,endDate) {
	...
	if(startDate)
	{
		formattedStartDate = startDate.format(self.format) || '';
	}

	if(endDate)
	{
		formattedEndDate = endDate.format(self.format) || '';
	}

	var range = {startDate: formattedStartDate, endDate: formattedEndDate, startDateAsMoment: startDate, endDateAsMoment: endDate};
